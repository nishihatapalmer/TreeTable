...
class TreeTableModelTest {
    ...
    //TODO: set values and test them!  can follow same grouping expansion pattern - but maybe test that changed values move around
    //      correctly after sort / group operations?
